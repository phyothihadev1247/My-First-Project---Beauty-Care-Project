  ...
  <div class="container">
    <div class="row justify-content-md-center">
      <div class="col-12 col-md-10 col-lg-8 col-xl-7 col-xxl-6">
        ...
        <p class="text-secondary mb-5 text-center lead fs-4">Our clinic is available to provide prompt and helpful responses to all treatments. You can reach us via phone, email, or by filling out the contact form below.</p>
                ...
                <div class="row align-items-lg-center justify-content-center h-100">
                  <div class="col-11 col-xl-10">
                    <div class="contact-info-wrapper py-4 py-xl-5">
                      ...
                      <p class="lead fs-4 text-light opacity-75 mb-4 mb-xxl-5">We're always on the lookout to booking with new treatments. If you're interested in booking with us, please get in touch in one of the following ways.</p>
