      ...
      <section class="container-sm mt-5">
        ...
        <form method="post" enctype="multipart/form-data">
          ...
          <div class="mb-3">
            ...
            <input type="text" name="special" class="form-control" id="" />
          </div>
        <button type="submit" name="btnaddstaff" class="btn btn-warning w-100 my-3 fw-bold">Add Staff</button>
        </form>
        <br>
      </section>
    </main>
