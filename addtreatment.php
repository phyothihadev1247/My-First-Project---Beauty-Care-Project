      ...
      <section class="container-sm mt-5">
        ...
        <form method="post" enctype="multipart/form-data">
          ...
          <div class="mb-3">
                ...
                <input type="text" name="des" id="description" class="form-control" rows="3">
          </div>
          <div class="mb-3">
            <label for="duration" class="form-label fw-bold">Duration</label>
            <input type="text" name="dur" id="duration" class="form-control" />
          </div>
          <div class="mb-3">
        ...
        <button type="submit" name="btnaddtreatment" class="btn btn-warning w-100 my-3 fw-bold">Add Treatment </button>
        </form>
        <br>
      </section>
    </main>
