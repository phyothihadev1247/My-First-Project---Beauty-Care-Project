  ...
  <body>
    ...
    <main class="container-sm rounded-4 border mt-5 mb-3">
            ...
            <div class="mb-3">
              ...
              <input type="text" name="role" value="<?php echo $role?>" class="form-control bg-transparent fw-normal p-2" id="">
            </div>
            <div class="mb-3">
              <label for="" class="form-label fw-bold">Speciality</label>
              <input type="text" name="special" value="<?php echo $special?>" class="form-control bg-transparent fw-normal p-2" id="">
            </div>
